...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('beranda') }}">
        <img src="{{ asset('../assets/img/logos/logo2.png') }}" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">CITO Medical</span>
    </a>
  </div>
  ...
  <div class="collapse navbar-collapse  w-auto" id="sidenav-collapse-main">
    <ul class="navbar-nav">
        ...
        <a class="nav-link {{ (Request::is('transaksi') ? 'active' : '') }} " href="{{ url('transaksi') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            ...
            <span class="nav-link-text ms-1">Transaksi Baru</span>
             ...
             <li class="nav-item">
         <a class="nav-link {{ (Request::is('harian_transaksi') ? 'active' : '') }}" href="{{ url('harian_transaksi') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('daftar_transaksi') ? 'active' : '') }}" href="{{ url('daftar_transaksi') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
              <title>office</title>
              <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      @if (Auth::user()->role == 'Super' || Auth::user()->role == 'Dokter')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('md') ? 'active' : '') }}" href="{{ url('md') }}">
                 <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
          ...
          <span class="nav-link-text ms-1">MD</span>
        </a>
      </li>
      @endif

      @if (Auth::user()->role == 'Super' || Auth::user()->role == 'Perawat')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('perawat') ? 'active' : '') }}" href="{{ url('perawat') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 42 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
     ...
     @endif
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('coming') ? 'active' : '') }} " href="{{ url('coming') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="20px" viewBox="0 0 40 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
          ...
          <span class="nav-link-text ms-1">Stok Obat</span>
        </a>
      </li>
      ...
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('coming') ? 'active' : '') }} " href="{{ url('coming') }}">
          ...
          <span class="nav-link-text ms-1">Jadwal Shift</span>
        </a>
      </li>
